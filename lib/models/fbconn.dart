...
class FbConn {
  ...
  List<String> getRestaurantAsList() {
    List<String> value = [];
    for (int s = 0; s < objectData.keys.length; s++) {
      Map val = objectData[objectData.keys.elementAt(s)];
      value.add(val[AppData.restaurantName]);
    }
    return value;
  }

  List<String> getRestaurantImageAsList() {
    List<String> value = [];
    for (int s = 0; s < objectData.keys.length; s++) {
      Map val = objectData[objectData.keys.elementAt(s)];
      value.add(val[AppData.restaurantImgURL]);
    }
    return value;
  }
  ...
  List<String> getProductSpicesAsList() {
    List<String> value = [];
    for (int s = 0; s < objectData.keys.length; s++) {
      Map val = objectData[objectData.keys.elementAt(s)];
      value.add(val[AppData.productSpicesAvailable]);
    }
    return value;
  }

  List<String> getProductRestaurantsAsList() {
    List<String> value = [];
    for (int s = 0; s < objectData.keys.length; s++) {
      Map val = objectData[objectData.keys.elementAt(s)];
      value.add(val[AppData.productRestaurantsAvailable]);
    }
    return value;
  }
  ...
  String getProductColors() {
    ...
    for (int s = 0; s < objectData.keys.length; s++) {
      value = objectData[objectData.keys.elementAt(s)]
          [AppData.productRestaurantsAvailable];
    }
    return value == null ? "" : value.toString();
  }
  ...
  String getProductSizes() {
    ...
    for (int s = 0; s < objectData.keys.length; s++) {
      value = objectData[objectData.keys.elementAt(s)]
          [AppData.productSpicesAvailable];
    }
    return value == null ? "" : value.toString();
  }
  ...
  List<String> getDefaultIMGAsList() {
    ...
    for (int s = 0; s < objectData.keys.length; s++) {
      Map val = objectData[objectData.keys.elementAt(s)];
      List<String> data = val[AppData.productImgURL]
          .toString()
          .replaceAll("[", "")
          .replaceAll("]", "")
          .split(",")
  ...
  List<String> getPictorialsServicesAsList() {
    List<String> value = [];
    for (int s = 0; s < objectData.keys.length; s++) {
      Map val = objectData[objectData.keys.elementAt(s)];
      value.add(val[AppData.serviceName]);
    }
    return value;
  }

  List<String> getServicesImageAsList() {
    List<String> value = [];
    for (int s = 0; s < objectData.keys.length; s++) {
      Map val = objectData[objectData.keys.elementAt(s)];
      value.add(val[AppData.serviceImgURL]);
    }
    return value;
  }

  List<String> getServicesNameAsList() {
    List<String> value = [];
    for (int s = 0; s < objectData.keys.length; s++) {
      Map val = objectData[objectData.keys.elementAt(s)];
      value.add(val[AppData.serviceName]);
