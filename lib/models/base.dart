...
class Base {
  ...
  final String spicesAvaliable;
  final String restaurantsAvaliable;
  final int noInStock;
  int itemQuantity;
  bool isFavorite;
  ...
  Base.messages(
      ...
      this.productPrice,
      this.spicesAvaliable,
      this.restaurantsAvaliable,
      this.noInStock,
      this.senderName,
      this.senderImgUrl,
      this.messageTime,
  ...
  buildDemoProducts() {
    return <Base>[
      Base.products(
          ...
          productPrice: 1999.0,
          spicesAvaliable: "30,35,40,45",
          restaurantsAvaliable: "red, yellow, blue, green",
          itemQuantity: 1,
          isFavorite: true),
      Base.products(
          productTitle: "Pizza",
  ...
  buildDemoMessages() {
    return <Base>[
      Base.messages(
          ...
          messageSent: "Hello , how long does it take to deliver ?"),
      Base.messages(
          senderName: "Judith",
          senderImgUrl:
