...
class _BoutiqueItemState extends State<BoutiqueItem> {
  ...
  List<String> sizesAvList = [];
  List<String> colorsAvList = [];
              ...
              new IconButton(
                ...
                onPressed: () {
                  Navigator.of(context).push(new CupertinoPageRoute(
                      builder: (BuildContext context) => new JamarCart()));
                },
              ),
              new Padding(
                    ...
                    child: new Column(
                      ...
                      children: <Widget>[
                        ...
                        new Text(
                          ...
                          "KES." + widget.productPrice.toString(),
                          style: const TextStyle(
                        ...
                        onTap: () {
                          ...
                          Navigator.of(context)
                            ...
                            builder: (BuildContext context) => new BoutiqueItem(
                              ...
                              productPrice:
                                  fbConnSub.getProductPriceAsList()[index],
                              // index: index,
                              productImage:
                                  fbConnSub.getDefaultIMGAsList()[index],

                              productCategory:
                                  fbConnSub.getProductCategoryAsList()[index],
                              productQuantity: num.parse(
                                  fbConnSub.getProductNoInStockAsList()[index]),
                              fbConn: widget.fbConn /*fbConnSub*/,
                              sizesAvailable:
                                  fbConnSub.getProductSpicesAsList()[index],
                              colorsAvailable: fbConnSub
                                  .getProductRestaurantsAsList()[index],
                              itemKey: fbConnSub.getKeyIDasList()[index],
                              index: index,
                            ),
                          ));
                        },
