...
class JamarAppChat extends StatefulWidget {
  @override
  _JamarChatsState createState() => new _JamarChatsState();
}

class _JamarChatsState extends State<JamarAppChat> {
  ...
  Future _getUserMessages() async {
    ...
    await messageRef.once().then((snapshot) {
...
class ChatMessage extends StatelessWidget {
  ...
  final String userid;
  final TimeAgo timeAgoo = new TimeAgo();
  BuildContext context;
  Size screenSize;
