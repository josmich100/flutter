...
import 'package:jamar/app/screens/payment.dart';
import 'package:jamar/main.dart';
import 'package:jamar/models/fbconn.dart';

class JamarCart extends StatefulWidget {
  @override
  _JamarCartState createState() => new _JamarCartState();
}

class _JamarCartState extends State<JamarCart> {
