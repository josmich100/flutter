...
import 'package:jamar/app/screens/order_item.dart';
import 'package:jamar/main.dart';
import 'package:jamar/models/fbconn.dart';
import 'package:jamar/models/ref_time.dart';

class JamarOrder extends StatefulWidget {
  @override
  _JamarBoutiqueState createState() => new _JamarBoutiqueState();
}

class _JamarBoutiqueState extends State<JamarOrder> {
                ...
                final row = new GestureDetector(
                  ...
                  onTap: () {
                    Navigator.of(context).push(new CupertinoPageRoute(
                        builder: (BuildContext context) => new JamarOrderItem(
