...
import 'package:jamar/support/screens/requests.dart';
            ...
            child: new Container(
              ...
              child: new Row(
                  ...
                  children: <Widget>[
                    ...
                    new Text(
                      "TOTAL : KES. ${length == 0 ? "0" : fbconn.getAdminTotalProductPrice().toString()}",
                      style: new TextStyle(
                          fontSize: 15.0, fontWeight: FontWeight.w700),
                    ),
                  ]),
                ...
                final row = new GestureDetector(
                  ...
                  onTap: () {
                    Navigator.of(context).push(new CupertinoPageRoute(
                        builder: (BuildContext context) => new JamarRequests(
